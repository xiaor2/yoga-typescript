...
const ContactUs = ({ setSelectedPage }: Props) => {
  ...
  const onSubmit = async (e: unknown) => {
    ...
    if (!isValid) {
      (e as React.MouseEvent<HTMLInputElement>).preventDefault();
    }
  }
      ...
      <div className="mt-10 justify-between gap-8 md:flex">
        ...
        >
          <form
            target="_blank"
            onSubmit={onSubmit}
            action="https://formsubmit.co/0df78b6018324706c2167eb292dedebc"
            method="POST"
          >
            <input 
            ...
            {errors.message && (
              <p className="mt-1 text-primary-500">
                ...
                {errors.message.type === "pattern" && "Max length is 200 character."}
              </p>
            )}
